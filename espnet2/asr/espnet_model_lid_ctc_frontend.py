...
class ESPnetASRLIDCTCFrontendModel(AbsESPnetModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # 1. Encoder
        encoder_out, encoder_out_lens, frontend_intermediate_outs = self.encode(speech, speech_lengths)
    ...
    def encode(
        ...
        with autocast(False):
            # 1. Extract feats
            feats, feats_lengths, frontend_intermediate_outs = self._extract_feats(speech, speech_lengths)
    ...
    def _extract_feats(
        ...
        if self.frontend is not None:
            ...
            feats, feats_lengths, frontend_intermediate_outs = self.frontend(speech, speech_lengths)
        else:
